...
//	CUtlString Ellipsify(int nChop);
//
...
//	void Clear() { Purge(); }
//
//	CUtlString Remove(const char* string, bool bCaseSensitive = true) const;
//	void		RemoveDotSlashes(char replacement);
//	CUtlString RemoveFromStart(const char* search, bool bCaseSensitive = true) const;
//
//	// Replaces all instances of specified char with a char
//	CUtlString Replace(char cSearch, char cReplace) const;
//	// Replaces all instances of specified char with a string
//	CUtlString Replace(const char cSearch, const char* pszReplacement) const;
//	// Replaces all instances of specified string with another string
//	CUtlString Replace(const char* pszSearch, const char* pszReplacement, bool bCaseSensitive = true) const;
//
