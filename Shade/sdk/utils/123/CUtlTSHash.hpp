...
////
////template <typename T>
////__declspec(noinline) bool IsValid2(void* p) {
////    __try {
...
////    }
////}
////template <typename T, int BucketCount, typename KeyType, typename HashFuncs>
////template <typename Predicate>
////inline std::vector<T> CUtlTSHash<T, BucketCount, KeyType, HashFuncs>::merge_without_duplicates(const std::vector<T>& allocated_list,
...
//
////template <typename T, int BucketCount, typename KeyType, typename HashFuncs>
////std::vector<T> CUtlTSHash<T, BucketCount, KeyType, HashFuncs>::GetElements(int nFirstElement) {
