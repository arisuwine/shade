...
namespace offsets {
	...
	namespace CViewSetup {
		CONST_OFFSET m_flFov							= 0x4d8; // 4ed8
		CONST_OFFSET m_flFovViewModel					= 0x4dc; // 0x4ec
		CONST_OFFSET m_vecOrigin						= 0x4e0; // 4f0
		CONST_OFFSET m_angView							= 0x4fc; // 50c
		CONST_OFFSET m_flAspectRatio					= 0x518; // 52c
		CONST_OFFSET m_nSomeFlags						= 0x595; // 5a1
	}
